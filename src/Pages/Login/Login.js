...
const Login = () => {
    ...
    return (
        <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl bg-slate-200 dark:text-gray-100 py-8 pb-8">
            ...
            <div className="flex items-center pt-4 space-x-1">
                ...
                <p className="px-3 text-sm dark:text-gray-400">Login with google account</p>
                <div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
            </div>
            <div className="flex justify-center space-x-4">
                <button onClick={handleGoogleSignIn} aria-label="Log in with Google" className="p-3 rounded-sm bg-green-100">
